...
{
    /// <summary>Converts the written text to a <see cref="SourceText"/> instance and resets the writer state.</summary>
    ...
    {
        return SourceText.From(writer.ToStringAndReset(), Encoding.UTF8);
    }
}
